	...
	<div class="row">
		...
		<div class="login-box span5 center-box txt-center img-rounded box-shadow">
			...
			<form>
				...
				<hr>
				<fieldset>
					<button id="loginBtn" type="button" class="btn btn-primary btn-large">
						<span id="signin">Sign in</span><span
						id="loading" style="display: none;"><img
							src="{{appContext}}/themes/{{theme}}/img/ajax-loader.gif" style="height:19px"></span>
					</button>
				</fieldset>
			</form>
		</div>
